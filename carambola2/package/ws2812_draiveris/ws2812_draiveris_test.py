...
while True:
  for i in range(30):
    ...
    data += [0,3,0]*(i) + [val>>2,val>>2,val>>2] + [0,3,0]*(29-i)
    data += [0,3,0]*(i) + [val,val,val] + [0,3,0]*(29-i)
    data += [0,3,0]*(i) + [30-i,30-i,i] + [0,3,0]*(29-i)
  ...
  for i in range(30):
    ...
    data += [1,0,0]*(29-i) + [0,val,val] + [1,0,0]*(i)
    data += [1,0,0]*(i)    + [val,0,val] + [1,0,0]*(29-i)
    data += [1,0,0]*(29-i) + [val,val,0] + [1,0,0]*(i)

    data += [0,3,0]*(29-i) + [val>>2,val>>2,val>>2] + [0,3,0]*(i)
    data += [0,3,0]*(29-i) + [val,val,val] + [0,3,0]*(i)
    data += [0,3,0]*(29-i) + [i,i,30-i] +    [0,3,0]*(i)
    os.write(dev, bytearray(data))
    time.sleep(0.02)
